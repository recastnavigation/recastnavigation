...
{
	const unsigned char r = static_cast<unsigned char>(fr * 255.0f);
	const unsigned char g = static_cast<unsigned char>(fg * 255.0f);
	const unsigned char b = static_cast<unsigned char>(fb * 255.0f);
	const unsigned char a = static_cast<unsigned char>(fa * 255.0f);
