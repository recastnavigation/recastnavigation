...
struct dtNavMeshCreateParams
{
	...
	const unsigned int* polyAreas;			///< The user defined areas assigned to each polygon. [Size: #polyCount]
	...
	/// User defined areas assigned to the off-mesh connections. [Size: #offMeshConCount]
	const unsigned int* offMeshConAreas;
