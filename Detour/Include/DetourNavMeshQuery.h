...
public:
	...
	virtual void
	process(const dtMeshTile *tile, dtPoly **polys, dtPolyRef *refs, int count) = 0;
};
...
public:
	...
	//============================================================
	dtStatus findStraightPath_reversed(const float *startPos, const float *endPos,
									   const dtPolyRef *path, const int pathSize,
									   float *straightPath, unsigned char *straightPathFlags, dtPolyRef *straightPathRefs,
									   int *straightPathCount, const int maxStraightPath, const int options = 0) const;
	dtStatus findStraightPath_shifted(const float *startPos, const float *endPos,
									  const dtPolyRef *path, const int pathSize,
									  float *straightPath, float *_straightPath, const float shift_coe, unsigned char *straightPathFlags, dtPolyRef *straightPathRefs,
									  int *straightPathCount, const int maxStraightPath, const int options = 0) const;
...
private:
	...
	dtStatus _appendVertex(const float *pos, const float *shifted_pos, const unsigned char flags, const dtPolyRef ref,
	...
	dtStatus _appendPortals(const int startIdx, const int endIdx, const float *endPos, const dtPolyRef *path,
							float *straightPath, float *_straightPath, unsigned char *straightPathFlags, dtPolyRef *straightPathRefs,
							int *straightPathCount, const int maxStraightPath, const int options) const;
