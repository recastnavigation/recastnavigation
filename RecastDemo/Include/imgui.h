...
inline uint32_t imguiRGBA(const uint8_t r, const uint8_t g, const uint8_t b, const uint8_t a=255)
{
	return (r) | (g << 8) | (b << 16) | (a << 24);
}

void imguiBeginFrame(int mx, int my, uint8_t mbut, int scroll);
void imguiEndFrame();
