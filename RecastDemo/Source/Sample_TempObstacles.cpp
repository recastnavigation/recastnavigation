							   ...
							   const int maxTiles)
{
	...
	// Tile bounds.
	const float tcs = cfg.tileSize * cfg.xzPlaneFieldCellSize;
	...
	tcfg.bmin[0] -= tcfg.borderSize*tcfg.xzPlaneFieldCellSize;
	tcfg.bmin[2] -= tcfg.borderSize*tcfg.xzPlaneFieldCellSize;
	tcfg.bmax[0] += tcfg.borderSize*tcfg.xzPlaneFieldCellSize;
	tcfg.bmax[2] += tcfg.borderSize*tcfg.xzPlaneFieldCellSize;
	...
	if (!rcCreateHeightfield(ctx, *rc.solid, tcfg.width, tcfg.height, tcfg.bmin, tcfg.bmax, tcfg.xzPlaneFieldCellSize, tcfg.ch))
	{
...
bool Sample_TempObstacles::handleBuild()
{
	...
	cfg.xzPlaneFieldCellSize = m_cellSize;
	cfg.ch = m_cellHeight;
	cfg.walkableSlopeAngle = m_agentMaxSlope;
	cfg.walkableHeight = (int)ceilf(m_agentHeight / cfg.ch);
	cfg.walkableClimb = (int)floorf(m_agentMaxClimb / cfg.ch);
	cfg.walkableRadius = (int)ceilf(m_agentRadius / cfg.xzPlaneFieldCellSize);
